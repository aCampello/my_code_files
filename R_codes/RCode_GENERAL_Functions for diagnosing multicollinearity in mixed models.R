...
#==================================================================
# DIFFERENT FUNCTIONS TO ASSESS MULTICOLLINEARITY IN MIXED MODELS
#==================================================================
...
colldiag.mer(model) # wouldnt work for log10 lmer model
...
maxcorr.mer(model) # wouldnt work for log10 lmer model